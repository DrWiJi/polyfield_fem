...
- **Acoustics (optional path):** A **3D Cartesian pressure grid** is coupled to FE motion using a **second-order pressure wave** solver with open/rigid boundary kinds (`air_pressure_wave_second_order_bc`).
